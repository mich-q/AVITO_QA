...
**Исторический статус полного прогона на 18 апреля 2026:** `62 passed, 6 failed`

**Статус для CI/CD после маркировки известных дефектов:** `62 passed, 6 xfailed`

Этим ожидаемым `xfailed` соответствуют следующие bugs:
